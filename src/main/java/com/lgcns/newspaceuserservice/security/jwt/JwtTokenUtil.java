package com.lgcns.newspaceuserservice.security.jwt;
...
import com.lgcns.newspaceuserservice.security.constant.GrantType;
import com.lgcns.newspaceuserservice.security.constant.TokenType;
...
public class JwtTokenUtil {
        ...
        if (StringUtils.hasText(token)) {
            if (token.startsWith(GrantType.BEARER.getType())) {
                ...
                return tokenSubstring;
            	 ...
            	 throw new UserException(UserResponseStatus.INVALID_BEARER_GRANT_TYPE);
            }
        }
        throw new UserException(UserResponseStatus.TOKEN_INVALID);
    }
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new UserException(UserResponseStatus.TOKEN_EXPIRED);
        }
    }
