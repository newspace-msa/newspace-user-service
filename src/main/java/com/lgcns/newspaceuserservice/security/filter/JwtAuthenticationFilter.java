package com.lgcns.newspaceuserservice.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lgcns.newspaceuserservice.dto.LoginRequestDto;
...
import com.lgcns.newspaceuserservice.security.util.FilterResponseUtil;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    @Override
     protected void successfulAuthentication(HttpServletRequest httpServletRequest,
        ...
        FilterResponseUtil.sendFilterResponse(httpServletResponse,
                ...
                UserResponseStatus.LOGIN_SUCCESS);
    }
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest httpServletRequest,
        ...
        FilterResponseUtil.sendFilterResponse(httpServletResponse,
                ...
                UserResponseStatus.LOGIN_FAILED);
    }
